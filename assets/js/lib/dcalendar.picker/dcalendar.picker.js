	...
	DCalendar.prototype = {
		...
		create : function(){
			var that = this,
				...
				cardhead = $(''),
				container = $('<div class="calendar-container shadowPadrao"></div>'),
				...
				datesgrid = $('<section class="calendar-grid">'
							+ '<div class="calendar-labels"><span>Dom</span><span>Seg</span><span>Ter</span><span>Qua</span><span>Qui</span><span>Sex</span><span>Sab</span></div>'
...
/* ELEMENTO DE DATA NO INPUT */
$(document).ready(function() {
  $(".dtpicker").dcalendarpicker({format: "dd-mm-yyyy"});
});